...
Recordset1_cmd.CommandText = "SELECT ID, LastName, FirstName FROM SpanishFork2015 WHERE LastName LIKE ? ORDER BY LastName ASC" 
...
%>
    <span class="Text"><a href="display.asp?LastName=<%=(Recordset1.Fields.Item("LastName").Value)%>&FirstName=<%=(Recordset1.Fields.Item("FirstName").Value)%>&Unique=<%=(Recordset1.Fields.Item("ID").Value)%>">
...
<% If Recordset1.EOF And Recordset1.BOF Then %>
    ...
    <br />
    <Form action="index_sales.asp"><input type="submit" value="New Search" /></Form>
